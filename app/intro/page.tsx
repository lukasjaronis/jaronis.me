	...
	return (
		<section className="flex items-center justify-center h-[calc(100vh_-_128px)]">
			<div className="max-w-xl flex flex-col w-full">
				...
				<p className="md:indent-10">Finishing up <Link href="/projects" className="underline underline-offset-4 font-black hover:text-firefly-100">Gate</Link> which is the 'genesis' service for a 1-click serverless service incumbator which
